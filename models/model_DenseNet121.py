...
def build_densenet121_model(input_shape=(160,160,3), num_classes=NUM_CLASSES,
                            layer1=512, layer2=256, dropout_rate=0.4, lr=1e-3):
...
model.save("DenseNet121_FER2013.h5")
print("Model saved successfully as DenseNet121_FER2013.h5")